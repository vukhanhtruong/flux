...
2. **Telegram bot creation** — QR code + step-by-step instructions for [@BotFather](https://t.me/botfather)
3. **Telegram user ID** — QR code + instructions for [@raw_data_bot](https://t.me/raw_data_bot)
