          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-1.5 h-[46px] text-white outline-none focus:border-primary/50 transition-colors"
              >
                <option value="Utilities" className="bg-dark">
                  Utilities
                </option>
                <option value="Entertainment" className="bg-dark">
                  Entertainment
                </option>
                <option value="Health" className="bg-dark">
                  Health
                </option>
                <option value="Shopping" className="bg-dark">
                  Shopping
                </option>
